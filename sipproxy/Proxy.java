...
/*****************************************************************************/
	      ...
	      */
            ...
            if ( registrar.hasRegistration(request) && !proxyDecorator.checkBlocking(request) && (!proxyDecorator.checkloops(request)) ) {
                ...
                //System.out.println(proxyDecorator.findForwardTarget(request)+"\n");
                request = proxyDecorator.forwardRequest(request,addressFactory, headerFactory);
            	/*System.out.println(request.toString() + " see my puri-puri\n");
        		Header head = request.getHeader(ToHeader.NAME);*/
/*        		String t = head.toString();
        		t=t+"hello";
        		head = (Header) t;
        		request.setHeader(t);
*/                targetURIList=registrar.getContactsURI(request);
